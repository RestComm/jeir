...
/**
 * Version class reads the version.properties packaged with eir for
 * run time display of Mobicents EIR Version
 * 
 * @author amit.bhayani
 * 
 */
public final class Version {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("Mobicents EIR Server: ");
		boolean first = true;
